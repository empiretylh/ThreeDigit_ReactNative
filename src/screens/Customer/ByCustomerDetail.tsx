...
const ByCustomerDetail = ({ navigation, route }) => {
    ...
    useEffect(() => {
        salesTable.getAllSalesByCustomer(setNumbers, customer);
    }, []);
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#f0f0f0' }}>
            ...
            <View style={{
                ...
                <Text style={{ ...STYLES.title, fontSize: 25 }}>{customer}</Text>
...
export default ByCustomerDetail;
